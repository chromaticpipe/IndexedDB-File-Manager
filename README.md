...
> This Project is still considered a WIP because I want to be able to name the database and object within differently (or whatever the fuck they're called), and even be able to access the IndexedDB root if possible
